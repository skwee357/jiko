...
showFeedImage = false # whether to show featured images in the feed view (default to false)
showAuthor = true # whether to show the author under each post (default to true)
